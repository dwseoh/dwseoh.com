/** Small inline icons for the blog, in the same 24px stroke style as the rest
 *  of the site (see OpenInNewIcon in app/[locale]/page.tsx). */
...
export function HeartIcon({ size = 15, className, filled = false }: IconProps & { filled?: boolean }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={filled ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden>
